...
typedef struct _Encap_Header{
               ...
               }__attribute__((packed)) Encap_Header;
...
typedef struct _Service_Information{
                       ...
                       char Name[16];
                    }__attribute__((packed)) Service_Information;
...
typedef struct _Identity_Information{
                         ...
                         }__attribute__((packed)) Identity_Information;
...
typedef struct _ListInterface_Reply{
                      ...
                      }__attribute__((packed)) ListInterface_Reply;
...
typedef struct _ListServices_Reply{
                      ...
                      }__attribute__((packed)) ListServices_Reply;
...
typedef struct _ListIdentity_Reply{
                      ...
                      }__attribute__((packed)) ListIdentity_Reply;
...
typedef struct _RegisterSession_Request{
                          ...
                          }__attribute__((packed)) RegisterSession_Request;
...
typedef struct _SendData_Request{
                     ...
                     }__attribute__((packed)) SendData_Request;
...
typedef struct _Eip_Session{
		...
		int References;
		void *Data;
		}__attribute__((packed)) Eip_Session;
...
typedef struct _Eip_Connection{
	  /* Connected send parameters */
		...
		BYTE Path_size;//
		//BYTE Path[0];
		}__attribute__((packed)) Eip_Connection;
...
#define OpenSession(serveur) _OpenSession(serveur,EIP_PORT,MAX_MSG_LEN,CIP_DEFAULT_TIMEOUT);
