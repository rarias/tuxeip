...
typedef int CIP_DINT;	//2147483648..2147483647  32 bits signed pvbrowser modification
//typedef long CIP_DINT;	//2147483648..2147483647	32 bits signed
// typedef long long int CIP_LINT;	//2^0..2^63 64 bits signed
// pvbrowser modification type not needed and makes error on windows
