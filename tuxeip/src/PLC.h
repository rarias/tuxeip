...
#define PCCC_READ_QUEUE_STATUS_FNC 0xA1
#define PCCC_READ_QUEUE_DATA_FNC 0xA2
...
typedef struct _PCCC_Header{
                    ...
                    CIP_INT TNS;
                            }__attribute__((packed)) PCCC_Header;
...
typedef struct _DHP_Header{
                    ...
                    //BYTE data; // the PCCC request
                            }__attribute__((packed)) DHP_Header;

typedef struct _PCCC_Requestor_ID{
                    CIP_USINT Length;
                    CIP_UINT VendorID;
                    CIP_UDINT Serial_Number;
                                }__attribute__((packed)) PCCC_Requestor_ID;

typedef struct _Logical_Binary_Address{
                    BYTE size;
                    BYTE address[10];
                    unsigned int mask;
                                }__attribute__((packed)) Logical_Binary_Address;

typedef struct _Three_Address_Fields{
                    BYTE size;
                    BYTE address[10];
                    unsigned int mask;
                                }__attribute__((packed)) Three_Address_Fields;
...
typedef struct _PCCC_SLCRW_Request{
                    ...
                    // adress
                    // BYTE Size;
                                }__attribute__((packed)) PCCC_SLCRW_Request;
...
typedef struct _PCCC_SLCRW_Reply{
                    ...
                    BYTE Ext_STS;
                    //BYTE Data[];
                                }__attribute__((packed)) PCCC_SLCRW_Reply;
...
PCCC_Header *_BuildPLCReadDataRequest(Plc_Type type,
                                      CIP_UINT tns,
                                      Logical_Binary_Address *lba,
                                      CIP_UINT number,
                                      int *requestsize,
                                      Data_Req_Type req_type);
...
PLC_Read *_ReadPLCData(Eip_Session *session,
                       Eip_Connection *connection,
                       DHP_Header *dhp,
                       BYTE *routepath,
                       CIP_USINT routepathsize,
                       Plc_Type type,
                       CIP_UINT tns,
                       char *address,
                       CIP_UINT number);
...
PLC_Read *_ReadPLCData_Ex(Eip_Session *session,
                          Eip_Connection *connection,
                          DHP_Header *dhp,
                          BYTE *routepath,
                          CIP_USINT routepathsize,
                          ...
                          CIP_UINT number,
                          Data_Req_Type req_type);
#define ReadPLCData_Ex(session,connection,dhp,routepath,routepathsize,type,tns,lba,number,req_type) \
                _ReadPLCData_Ex(session,connection,dhp,routepath,routepathsize,type,tns,lba,number,req_type)

int _WritePLCData(Eip_Session *session,
                  Eip_Connection *connection,
                  DHP_Header *dhp,
                  BYTE *routepath,
                  CIP_USINT routepathsize,
